    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$'), 'Nome do Usuário deve conter letras, números e ( @ . + - _ ).', 'invalid')], verbose_name='Nome de Usuário')),
                ...
                ('is_staff', models.BooleanField(blank=True, default=False, verbose_name='Admin')),
